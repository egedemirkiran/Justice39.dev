    ...
    <div className={`${ active ? '' : 'hidden'} w-full lg:inline-flex lg:flex-grow lg:w-auto `}>
      <div className='flex-wrap gap-5 lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto text-2xl px-5'>
        {pages.map((page, index) =>
          <a key={page.name} onClick={() => handleLink(page.href)} className='text-center elg:inline-flx lg:w-auto w-full px-3 py-2 rounded-full text-white items-center dark:sm:hover:bg-white/10 justify-center sm:bg-white/0 sm:hover:bg-gray-900/5 hover:text-white focus:outline-none focus:ring-0'>
